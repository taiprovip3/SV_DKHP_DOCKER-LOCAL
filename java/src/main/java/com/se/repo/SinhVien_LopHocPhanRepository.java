...
public interface SinhVien_LopHocPhanRepository extends CrudRepository<SinhVien_LopHocPhan, Long>{
	@Query(value = "SELECT * FROM sinh_vien_lop_hoc_phan WHERE ma_lop_hoc_phan = ?1 AND ma_sinh_vien = ?2", nativeQuery = true)
	public SinhVien_LopHocPhan isStudentRegisThisUnitClass(long unitClassId, long studentId);
	...
	public SinhVien_LopHocPhan getSVLHPsByMaLopHocPhanIdAndStudentId(long studentId, long unitClassId);
